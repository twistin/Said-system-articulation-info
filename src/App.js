  ...
  const sections = [
    {
      ...
      image: `${process.env.PUBLIC_URL}/power_diffusion.png`, // Ruta ajustada
    ...
    },
    {
      ...
      image: `${process.env.PUBLIC_URL}/consensus_manufacturing.png`, // Ruta ajustada
    ...
    },
    {
      ...
      image: `${process.env.PUBLIC_URL}/cultural_battlefield.png`, // Ruta ajustada
    ...
    },
    {
      ...
      image: `${process.env.PUBLIC_URL}/reclaiming_narrative.png`, // Ruta ajustada
    ...
    },
    {
      ...
      image: `${process.env.PUBLIC_URL}/navegando_laberinto.png`, // Ruta ajustada
